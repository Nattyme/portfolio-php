  ...
  <div class="container">
    <div class="page-project__title">
      ...
      <div class="page-project__info">
        <div class="page-project__date">02 Апреля 2020</div>
        <div class="badge">работы</div>
      </div>
    </div>
    <div class="page-project__preview"><img src="<?php echo HOST .'usercontent/img/portfolio/' . $project['coverSmall'];?>" alt="Верстка и frontend для интернет магазина" /></div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="page-project__content-item">
            ...
            <p class="special-link"><a href="#"><?php echo $project['link'];?></a></p>
          </div>
        </div>
      </div>
    </div>
