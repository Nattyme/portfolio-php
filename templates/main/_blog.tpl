    ...
    <div class="col-4">
      <div class="card-post">
        <div class="card-post__img">
          <a href="#">
            <img src="<?php echo HOST; ?>static/img/posts/post-1.jpg" alt="Как я встретил старого друга в NY и чем это закончилось" />
          </a>
        </div>
        <h4 class="card-post__title">
          <a href="#"> Как я встретил старого друга в NY и чем это закончилось</a>
        </h4>
      </div>
    </div>
    <div class="col-4">
      <div class="card-post">
        <div class="card-post__img">
          <a href="#">
            <img src="<?php echo HOST; ?>static/img/posts/post-2.jpg" alt="Парусный спорт. 10 правил для начинающего" />
          </a>
        </div>
        <h4 class="card-post__title"><a href="#"> Парусный спорт. 10 правил для начинающего</a></h4>
      </div>
    </div>
    <div class="col-4">
      <div class="card-post">
