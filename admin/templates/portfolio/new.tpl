...
<form class="admin-form" method="POST" action="<?php echo HOST;?>admin/project-new" enctype="multipart/form-data">
  ...
  <div class="admin-form__item">
    <label class="input__label">
      ...
      <input name="title" class="input input--width-label" type="text" placeholder="Название проекта" />
    </label>
  </div>
  <!-- <div class="admin-form__item">
  ...
  <div class="admin-form__item">
    ...
    <textarea name="about" class="textarea textarea--width-label" placeholder="Введите текст" id="editor"></textarea>
  </div>
  ...
  <div class="admin-form__item">
    ...
    <textarea name="tools" class="textarea textarea--width-label" placeholder="Введите текст" id="editor"></textarea>
  </div>
  <div class="admin-form__item">
    <label class="input__label">
