...
<form class="admin-form" method="POST" action="<?php echo HOST;?>admin/project-edit?id=<?php echo $project['id'];?>" enctype="multipart/form-data">
  ...
  <div class="admin-form__item">
    <label class="input__label">
      ...
      <input name="title" class="input input--width-label" type="text" placeholder="Введите название" 
             value="<?php echo isset($_POST['title']) ? $_POST['title'] : $project['title']; ?>"
      />
    </label>
  </div>
  ...
  <div class="admin-form__item">
    ...
    <textarea name="about" class="textarea textarea--width-label" placeholder="Введите описание" id="about">
      <?php echo isset($_POST['about']) ? $_POST['about'] : $project['about']; ?>
    </textarea>
  </div>
  <div class="admin-form__item">
    <label class="input__label input__label--details">
      Время работы над проектом:
      <input name="deadline" class="input input--width-label" type="text" placeholder="Введите время" 
             value="<?php echo isset($_POST['deadline']) ? $_POST['deadline'] : $project['deadline']; ?>"
      />
    </label>
  </div>
  <div class="admin-form__item">
    <label class="input__label input__label--details">
      ...
      <input name="pages" class="input input--width-label" type="number" placeholder="Введите количество" 
             value="<?php echo isset($_POST['pages']) ? $_POST['pages'] : $project['pages']; ?>"
      />
    </label>
  </div>
  <div class="admin-form__item">
    <label class="input__label input__label--details">
      ...
      <input name="budget" class="input input--width-label" type="text" placeholder="Введите сумму" 
             value="<?php echo isset($_POST['budget']) ? $_POST['budget'] : $project['budget']; ?>"
      />
    </label>
  </div>
  ...
  <div class="admin-form__item">
    <label class="input__label">
      ...
      <input name="link" class="input input--width-label" type="text" placeholder="Введите ссылку" 
             value="<?php echo isset($_POST['link']) ? $_POST['link'] : $project['link']; ?>"
      />
    </label>
  </div>
